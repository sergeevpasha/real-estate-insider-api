...
Route::post('/auth/github/invalidate', [GithubLoginController::class, 'invalidateGithub']);
Route::get('/login/google', [GoogleLoginController::class, 'redirectToGoogle']);
Route::get('/login/google/callback', [GoogleLoginController::class, 'handleGoogleCallback']);
Route::post('/auth/google/invalidate', [GoogleLoginController::class, 'invalidateGoogle']);
